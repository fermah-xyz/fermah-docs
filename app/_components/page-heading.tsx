...
const pathIconMap: Record<string, string> = {
  ...
  '/network/mainnet/for-prover-nodes': 'ph:cpu-duotone',
  '/network/mainnet/for-prover-nodes/installation': 'ph:download-duotone',
  '/network/mainnet/for-prover-nodes/provers': 'ph:gear-duotone',
  '/network/mainnet/for-prover-nodes/configuration': 'ph:sliders-duotone',
  '/network/mainnet/for-prover-nodes/machine-secret': 'ph:key-duotone',
  '/network/mainnet/for-prover-nodes/registration': 'ph:clipboard-text-duotone',
  '/network/mainnet/for-prover-nodes/telemetry': 'ph:chart-line-duotone',
  '/network/mainnet/for-prover-nodes/telemetry/custom-export': 'ph:export-duotone',
  '/network/mainnet/for-prover-nodes/starting-a-node': 'ph:play-duotone',
