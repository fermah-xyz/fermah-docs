...
**Custody.** Holding someone else's funds. The prepaid arrangement is custodial after the deposit, since the USDC is in the treasury the operator controls. The direct arrangement is not, at any point.
...
**Treasury.** An account the operator controls that holds deposited USDC as a SAC balance. The billing contract is a separate accounting ledger and holds no USDC itself. Both are distinct from the fee account, which pays XLM for transaction fees.
