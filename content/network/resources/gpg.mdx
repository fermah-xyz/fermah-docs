...
Hosted Fermah <GlossaryTooltip>GPG</GlossaryTooltip> signing key for verification of our executed scripts.
...
```bash
wget https://storage.googleapis.com/fermah-mainnet-releases/install.sh.asc
wget https://storage.googleapis.com/fermah-mainnet-releases/install.sh
gpg --verify install.sh.asc install.sh
```
