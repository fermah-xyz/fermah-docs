...
Operators may customize configurations for additional OpenTelemetry collectors. See [Custom Export](/network/mainnet/for-prover-nodes/telemetry/custom-export) for more details.
