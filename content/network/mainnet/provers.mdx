...
Provers can have their configuration customized through the Prover Node configuration, see [configuration](/network/mainnet/configuration).
...
[zksync.mode.CP]
num_workers = 16
max_gpu_vram_allocation = 25769803776
```
...
```toml
[zksync]
mode = { CP = { num_workers = 32, max_gpu_vram_allocation = 25769803776 } }
```
