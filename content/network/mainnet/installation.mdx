...
![Prover Node installation overview: prerequisites, prepare the server with Root Docker, Rootless Docker and CUDA, install the Fermah Prover Node, then the node joins the network and starts proving](/images/prover-node-installation.svg)
