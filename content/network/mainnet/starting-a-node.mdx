...
```bash
echo "fermah	soft	nofile	65535" | sudo tee -a /etc/security/limits.conf
echo "fermah	hard	nofile	65535" | sudo tee -a /etc/security/limits.conf
```
...
ExecStart=/home/fermah/.fermah/bin/fpn
...
ExecStartPre=/bin/chown fermah:fermah /var/log/fermah
